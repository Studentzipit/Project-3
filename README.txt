...
The input must be an Excel file (.xlsx) with the following two columns:
    ...
    Column "Name"  — Chemical trade name or common name (required)
    Column "CAS#"  — CAS registry number (may be left blank)
...
USAGE
-----
Run the CLI with an input file and a desired output filename:
...
Sample output row (ACRYLAMIDE, 99+%):
    ...
    Related CAS #s      : None
    Top 5 Chem Names    : ACRYLAMIDE
                          79-06-1
                          2-Propenamide
                          prop-2-enamide
                          Propenamide
    GHS Pictogram Names : Acute Toxic
                          Health Hazard
                          Irritant
